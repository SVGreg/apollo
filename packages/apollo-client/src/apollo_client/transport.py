...
class JsonTransport:
    ...
    Calls are moved to worker threads by :class:`ApolloClient`, keeping the
        ...
        try:
            with urllib.request.urlopen(
                ...
                try:
                    ...
                    raise ProtocolError(f"Apollo host returned invalid JSON from {path}") from exc
            ...
            raise NetworkError(f"Could not reach Apollo host at {url}: {reason}") from exc
