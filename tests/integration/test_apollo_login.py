...
def test_apollo_ssh_login():
    """Manual test to verify SSH login to remote Apollo instance."""
    run_apollo_ssh_login()


def run_apollo_ssh_login():
    host = os.getenv("APOLLO_SSH_TEST_HOST", "127.0.0.1")
    user = os.getenv("APOLLO_SSH_TEST_USER", "apollo")
    password = os.getenv("APOLLO_SSH_TEST_PASSWORD", "password")
