...
from apollo.agents.explorer.tiers import get_tier
from apollo.config import ExplorerVersion, resolve_explorer_version, settings
...
from apollo.utils.visualization import draw_dots
...
def register_candidates(
    ctx: ApolloContext, state: State, outcome: ExplorerOutcome
...
def render_annotated_image(
    ctx: ApolloContext, screenshot_path: str, registered: list[RegisteredCandidate]
) -> str | None:
...
class AskExplorerTool(ApolloTool):
    """``ask_explorer`` as an :class:`ApolloTool` (LangChain / GenAI / MCP export)."""
