...
from apollo.agents.object_detector.object_detector import (
...
class ObjectDetectionTool(ApolloTool):
...
def get_object_detector_tool(ctx: ApolloContext) -> BaseTool:
    """Exports object_detection as a LangChain BaseTool."""
    return trace_langchain_tool(object_detection.to_langchain_tool(ctx), ctx)


def get_operator_object_detector_tool(ctx: ApolloContext) -> BaseTool:
