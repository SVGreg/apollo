...
def get_list_notes_tool_pure(ctx: ApolloContext) -> BaseTool:
...
class SaveNotePureTool(ApolloTool):
...
def get_update_note_tool_pure(ctx: ApolloContext) -> BaseTool:
...
class AppendNotePureTool(ApolloTool):
...
def get_append_note_tool_pure(ctx: ApolloContext) -> BaseTool:
