...
from apollo.tools.history.replay import (
    DEFAULT_MAX_STEPS as DEFAULT_REPLAY_MAX_STEPS,
)
from apollo.tools.history.replay import (
    DEFAULT_MAX_TOKENS as DEFAULT_REPLAY_MAX_TOKENS,
)
from apollo.tools.history.replay import replay_steps_text
from apollo.tools.history.screenshot import ScreenshotResult, load_step_screenshot
from apollo.tools.history.search import search_history_text
...
class SearchHistoryTool(ApolloTool):
...
class ReplayStepsTool(ApolloTool):
...
class GetStepScreenshotTool(ApolloTool):
...
HISTORY_TOOLS: tuple[ApolloTool, ...] = (search_history, replay_steps, get_step_screenshot)
...
def history_tool_by_name(name: str) -> ApolloTool | None:
