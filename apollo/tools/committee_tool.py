...
from apollo.services.llm import get_llm, invoke_llm_with_timeout_message
...
from apollo.utils.notes import get_note_file_path, get_notes_dir
...
class AskCommitteeTool(ApolloTool):
...
def get_ask_committee_tool(ctx: ApolloContext) -> BaseTool:
...
async def _run_committee_logic(
    ...
    if ctx is None:
        return ToolFailure("Error: ApolloContext is required for ask_committee.")
