...
from apollo.data_engine.trace import CURRENT_TRACE_ID, smart_serialize
...
class ToolWrapper(BaseModel):
    ...
    tool_fn_getter: Callable[[ApolloContext], BaseTool]
    on_success_fn: Callable[..., str]
    on_failure_fn: Callable[..., str]
    is_available_fn: Callable[[ApolloContext], bool] | None = None


class CompositeToolWrapper(ToolWrapper):
    """Wrapper holding a composite tool factory and lifecycle callbacks."""

    composite_tools_fn_getter: Callable[[ApolloContext], list[BaseTool]]
