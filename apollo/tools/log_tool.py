...
class AnalyzeLogsTool(ApolloTool):
    ...
    async def execute(
        ...
        **kwargs: Any,
        ...
        if ctx is None:
            return ToolFailure("Error: ApolloContext is required for LogAnalyzer.")
...
def get_analyze_logs_tool(ctx: ApolloContext) -> BaseTool:
