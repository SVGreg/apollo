...
from apollo.controllers.types import (
...
from apollo.tools.types import Target
...
async def tap_bottom_right_of_element(bounds: ElementBounds, ctx: ApolloContext):
...
async def focus_element_if_needed(
    ctx: ApolloContext, target: Target
