...
from apollo.mcp.action_manifest import validate_actuator
from apollo.mcp.action_specs import (
    exception_prefix,
    make_wire_handler,
    wire_dialects,
)
from apollo.mcp.action_types import ActionCode, ActionResult, ObserveResult
from apollo.mcp.actuators.base import Actuator
from apollo.mcp.observation import observe as observe_impl
...
def build_action_server(actuator: Actuator, name: str = "apollo_actions") -> FastMCP:
    ...
    # (apollo/mcp/action_specs.py); this server contributes only the transport
