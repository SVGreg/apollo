...
``apollo.mcp.action_manifest.DEVICE_ACTIONS``) and may contribute tools nobody
...
from apollo.mcp.action_manifest import ExtensionTool
from apollo.mcp.action_types import ActionResult
