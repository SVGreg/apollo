...
from apollo.data_engine.trace import TraceSpan
from apollo.mcp.action_manifest import OPTIONAL_ACTIONS, REQUIRED_ACTIONS
from apollo.mcp.action_specs import exception_prefix
...
from apollo.mcp.actuators.adb import AdbActuator
from apollo.agents.validator.tool_declarations import (
    ToolExecutionResult,
    normalize_coordinate_target,
)
from apollo.tools.history import HISTORY_TOOL_NAMES, history_tool_by_name
from apollo.tools.tool_wrapper import split_multimodal_result
...
class McpActionExecutor:
    ...
    async def _ask_explorer(
        ...
        from apollo.tools.explorer_tool import locate, register_candidates, render_text
