...
from apollo.sdk.constants import DEFAULT_PROFILE_NAME
from apollo.sdk.types.agent import (
    AgentConfig,
    AgentProfile,
    ServerConfig,
)
from apollo.sdk.types.task import TaskRequestCommon
...
class AgentConfigBuilder:
    ...
    def add_profile(self, profile: AgentProfile, validate: bool = True) -> "AgentConfigBuilder":
        """Add an agent profile to the APOLLO agent.
    ...
    def add_profiles(
        ...
        """Add multiple agent profiles to the APOLLO agent.
    ...
    def for_device(
        ...
        """Configure the APOLLO agent for a specific device.
    ...
    def with_verification_level(self, level: str) -> "AgentConfigBuilder":
        ...
        Presets are defined once in :data:`apollo.config.VERIFICATION_LEVEL_PRESETS`:
    ...
    def with_explorer(
        ...
        never see it. Precedence at run time: ``APOLLO_EXPLORER_VERSION``, then
    ...
    def build(self, validate_profiles: bool = True) -> AgentConfig:
        """Build the APOLLO AgentConfig object.
        ...
        device_id = (
            self._device_id
            or os.environ.get("APOLLO_DEVICE_ID")
