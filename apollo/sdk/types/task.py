...
"""Task-related type definitions for the APOLLO SDK."""
...
from apollo.config import LLMConfig, get_default_llm_config
from apollo.constants import RECURSION_LIMIT
from apollo.context import DeviceContext
from apollo.sdk.types.platform import TaskRunStatus
...
class AgentProfile(BaseModel):
    """Represents a APOLLO agent profile.
