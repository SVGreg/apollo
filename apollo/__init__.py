...
"""☕ APOLLO: Autonomous Multimodal Android Agent & Testing Framework."""

from apollo._version import __version__

from apollo.interfaces.sdk.client import ApolloClient, ConcurrencyMode
from apollo.interfaces.sdk.task import StreamEvent, StreamEventType, Task
from apollo_client import Capabilities, Device, TaskHandle, TaskResult
