...
"""Batch tasks execution command (apollo batch)."""
...
from apollo.config import initialize_llm_config
...
def batch_command(
    ...
    standalone: Annotated[
        ...
        typer.Option(
            "--standalone",
            help="Run in standalone embedded mode without routing through Apollo Daemon.",
        ),
    ] = False,
