...
"""Interactive setup wizard for first-time APOLLO onboarding (apollo init)."""
...
from apollo.config.paths import get_env_file
...
def init_command() -> None:
    ...
    console.print(
        Panel(
            "[bold cyan]☕ Welcome to Apollo Mobile Testing Framework[/bold cyan]\n"
    ...
    if detected_devices:
        ...
        console.print(
            ...
            "[dim]Apollo will auto-detect your device when you connect it later.[/dim]"
        )

    # 4. Generate .env File
    env_content = [
        "# ==============================================================================",
        "# ☕ APOLLO Environment Configuration (Generated by 'apollo init')",
        "# ==============================================================================",
    ...
    env_content.extend(
        [
            "",
            "# Execution Defaults",
            "APOLLO_DEFAULT_PROFILE=pro",
            "APOLLO_DEFAULT_MODEL=gemini-2.5-flash",
            "APOLLO_TRACES_DIR=./traces",
            "",
        ]
    )
    ...
    console.print("\n[bold]Step 5: Connect Apollo to your AI IDE (MCP)[/bold]")
    ...
    if mcp_choice != "8":
        ...
        try:
            from apollo.interfaces.cli.commands.mcp import install_mcp_config
            ...
            console.print(
                f"[bold green]✔ Configured Apollo MCP in {len(installed_paths)} IDE location(s).[/bold green]"
            )
    ...
    console.print(
        Panel(
            ...
            '  [bold cyan]uv run apollo run "Open YouTube and search for Lo-Fi Hip Hop"[/bold cyan]\n\n'
            "Or connect/update your AI IDE anytime with:\n"
            "  [bold cyan]uv run apollo mcp --install all[/bold cyan]\n\n"
            "Or run health diagnostics anytime with:\n"
            "  [bold cyan]uv run apollo doctor[/bold cyan]",
            title="☕ Ready to Go!",
            expand=False,
        )
    )
