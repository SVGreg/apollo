...
Split out of ``apollo.agents.explorer.explorer``: the ``exec_*`` tool method
...
run's in-memory :class:`~apollo.agents.explorer.screen_index.ScreenIndex`;
...
from apollo.agents.explorer.geometry import norm_to_pixel, pixel_to_norm
from apollo.agents.explorer.screen_index import ScreenElement, ScreenIndex, normalize_text
