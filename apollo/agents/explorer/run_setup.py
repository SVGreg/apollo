...
Split out of ``apollo.agents.explorer.explorer``: the flash-tier one-shot
...
from apollo.agents.explorer.geometry import resolve_screen_size
from apollo.agents.explorer.perception_tools import load_detector_templates
from apollo.agents.explorer.screen_index import ScreenElement, ScreenIndex
from apollo.agents.explorer.tiers import SUBMIT_TOOL, ExplorerTier
...
from apollo.utils.visualization import draw_dots, format_minimal_list_with_elements
