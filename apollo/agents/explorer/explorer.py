...
from apollo.agents.explorer.constants import DEFAULT_EXPLORER_MODEL
...
from apollo.agents.explorer.native_runner import NativeRunnerMixin
from apollo.agents.explorer.perception_tools import PerceptionToolsMixin
from apollo.agents.explorer.run_setup import RunSetupMixin
from apollo.agents.explorer.screen_index import normalize_text, ScreenElement, ScreenIndex
from apollo.agents.explorer.tiers import ExplorerTier, get_tier
from apollo.agents.explorer.tool_declarations import NATIVE_EXPLORER_TOOL_DECLARATIONS
from apollo.agents.explorer.universal_runner import UniversalRunnerMixin
from apollo.config import settings
from apollo.context import ApolloContext
from apollo.data_engine.trace import trace
from apollo.graph.state import State
from apollo.llm.google import is_gemini_model, strip_provider_prefix
from apollo.utils.logger import get_logger
from apollo.utils.ocr_api import is_ocr_configured
...
CACHING_ENV_VAR = "APOLLO_EXPLORER_CACHING"
...
class Explorer(PerceptionToolsMixin, UniversalRunnerMixin, RunSetupMixin, NativeRunnerMixin):
    ...
    :data:`apollo.agents.explorer.tiers.EXPLORER_TIERS`; it decides the
    ...
    def _resolve_caching(self, tier: ExplorerTier, enable_caching: bool | None) -> bool:
        ...
        Precedence: explicit argument, ``APOLLO_EXPLORER_CACHING`` env
