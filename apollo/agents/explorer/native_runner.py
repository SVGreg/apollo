...
Split out of ``apollo.agents.explorer.explorer``: the native-SDK reasoning
...
from apollo.agents.explorer.geometry import is_valid_norm_point
from apollo.agents.explorer.tiers import SUBMIT_TOOL
...
from apollo.services.llm import _record_llm_event, _record_llm_retry
...
"""
    ...
    async def _run_native(
        ...
        *,
        ...
        use_file_api = os.getenv("APOLLO_USE_FILE_API", "false").lower() == "true"
        uploaded_files: list = []
