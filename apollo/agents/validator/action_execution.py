...
from apollo.mcp.action_names import to_canonical_call
from apollo.mcp.action_session import ActionSession
...
async def exec_action(
    ctx: ApolloContext, session: ActionSession, action_item: dict
) -> tuple[bool, str]:
