...
:class:`~apollo.memory.step_memory.StepMemoryService` visual-transition lens
...
from apollo.agents.flash.summarizer import build_focus_context
...
from apollo.memory import ensure_step_memory
...
class SummarizerNode:
    ...
    def _extract_action(record: Any, state: State, *, ctx: Any = None) -> tuple[str, dict]:
        ...
        from apollo.utils.coordinates import normalize_any_structure
