...
from apollo.llm.google import usage_from_message
...
from apollo.tools.index import get_tool_by_name
...
from apollo.memory.context_policy import build_history_for
...
class OperatorNode:
    ...
    def _ensure_transcript_ledger(self, state=None):
        ...
        from apollo.memory import TranscriptLedger, ensure_step_memory
    ...
    async def _invoke_llm_loop(
        ...
        for iteration in range(max_iterations):
            ...
            if usage is not None:
                ...
                from apollo.memory.transcript import estimate_prompt_tokens
    ...
    async def __call__(self, state: State):
        ...
        # (apollo/mcp/action_specs.py) and are assembled against the installed
