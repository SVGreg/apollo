...
``mock.patch("apollo.agents.video_analyzer.video_analyzer.<name>")`` targets
keep working.
"""
...
from apollo.agents.video_analyzer import video_analyzer as _va
from apollo.agents.video_analyzer.reliability import classify_video_failure
from apollo.constants import SAFETY_SETTINGS_BLOCK_NONE
from apollo.data_engine.trace import CURRENT_TRACE_ID, TraceSpan
from apollo.llm.google import normalize_usage
