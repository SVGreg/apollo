...
from apollo.context import AppLaunchResult, ApolloContext
...
def get_foreground_task(ctx: ApolloContext) -> ForegroundTask | None:
...
async def get_foreground_task_async(ctx: ApolloContext) -> ForegroundTask | None:
...
async def _observe_foreground(
    ctx: ApolloContext, app_package: str
