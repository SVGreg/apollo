...
from apollo.context import ApolloContext, DevicePlatform
from apollo.utils.logger import ApolloLogger, get_logger
from apollo.utils.shell_utils import run_shell_command_on_host

logger = get_logger(__name__)


def get_adb_device(ctx: ApolloContext) -> Any:
...
def list_packages(ctx: ApolloContext) -> str:
...
def get_current_foreground_package(ctx: ApolloContext) -> str | None:
