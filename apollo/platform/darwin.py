...
class DarwinPlatformPaths(IPlatformPaths):
    ...
    def config_dir(self) -> Path:
        p = self._home / "Library" / "Application Support" / "apollo"
    ...
    def data_dir(self) -> Path:
        ...
        # Check legacy ~/.apollo or ~/.gemini/jetski directory if it exists
    ...
    def cache_dir(self) -> Path:
        p = self._home / "Library" / "Caches" / "apollo"
        p.mkdir(parents=True, exist_ok=True)
        return p

    @property
    def logs_dir(self) -> Path:
        p = self._home / "Library" / "Logs" / "apollo"
        p.mkdir(parents=True, exist_ok=True)
        return p
