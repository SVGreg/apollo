...
from apollo.toolchain.descriptors import TOOLS, ToolDescriptor
...
class ToolchainResolver:
    ...
    def resolve(self, tool_name: str, force_refresh: bool = False) -> str | None:
        ...
        # Tier 1: Explicit environment variable override (e.g. APOLLO_ADB_PATH)
        env_var = f"APOLLO_{desc.name.upper()}_PATH"
